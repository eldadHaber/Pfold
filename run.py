...
# Data
parser.add_argument('--dataset-train', default='e:/test_lmdb.lmdb', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
...
parser.add_argument('--dataset-test', default='e:/small_test_lmdb.lmdb', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
