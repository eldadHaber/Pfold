...
# Data
parser.add_argument('--dataset-train', default='e:/training_100.lmdb', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
...
parser.add_argument('--dataset-test', default='e:/testing_100.lmdb', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
...
# parser.add_argument('--dataset-test', default='./data/pnet/train.pnet', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
...
parser.add_argument('--nlayers', default=200, type=int, metavar='N', help='Number of residual layers in network')
...
parser.add_argument('--max-iter', default=1e6, type=int, metavar='N', help='select the neural network to train (resnet)')
