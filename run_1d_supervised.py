...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset-train', default='./data/casp11_validation_inpaint/', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
    parser.add_argument('--dataset-test', default='./data/casp11_test_inpaint/', type=str, metavar='N', help='Name of dataset to run, currently implemented: ')
