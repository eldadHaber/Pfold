...
if __name__ == '__main__':
    ...
    # Input features
    parser.add_argument('--seq-flip-prop', default=1.5, type=float, metavar='N', help='Input feature types')
    ...
    parser.add_argument('--max-iter', default=20, type=int, metavar='N', help='select the neural network to train (resnet)')
    parser.add_argument('--report-iter', default=5, type=int, metavar='N', help='select the neural network to train (resnet)')
