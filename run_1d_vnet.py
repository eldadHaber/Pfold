...
if __name__ == '__main__':
    ...
    parser.add_argument('--i-pssm', default=False, type=bool, metavar='N', help='Input feature types')
    parser.add_argument('--i-entropy', default=False, type=bool, metavar='N', help='Input feature types')
    ...
    parser.add_argument('--use_cross_dist', default=False, type=bool, metavar='N', help='Input feature types')
    ...
    parser.add_argument('--load_from_previous', default='', type=str, metavar='N', help='Input feature types')
    parser.add_argument('--checkpoint', default=10000, type=int, metavar='N', help='Input feature types')
